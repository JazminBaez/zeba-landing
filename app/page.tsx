...
export default function FashionLanding() {
  const [currentBackground, setCurrentBackground] = useState("/images/background-models.jpg")

  const backgroundImages = {
    models: "/images/background-Models.jpg",
    scouting: "/images/background-Scouting.jpg",
    about: "/images/background-models.jpg",
  }
